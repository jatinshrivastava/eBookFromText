...
def runTestSuite():
    generator = SlideGenerator('testFile.pptx')
    generator.addSlide('Quote 1')
    generator.addSlide('Quote 2')
    generator.addSlide('Quote 3')
    generator.addSlide('Quote 4')
    generator.addSlide('Quote 5')
    generator.save()
